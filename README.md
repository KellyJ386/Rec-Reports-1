...
- Supabase Auth, Postgres, and RLS: 24 forward-only migrations with facility-scoped tenant isolation, platform super-admin and department-level permission scoping, append-only hash-chained audit trail, and idempotent policies
